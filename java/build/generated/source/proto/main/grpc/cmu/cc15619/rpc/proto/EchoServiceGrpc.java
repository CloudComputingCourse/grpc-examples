...
public final class EchoServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "proto.EchoService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<cmu.cc15619.rpc.proto.EchoRequest,
      cmu.cc15619.rpc.proto.EchoResponse> getEchoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Echo",
      requestType = cmu.cc15619.rpc.proto.EchoRequest.class,
      responseType = cmu.cc15619.rpc.proto.EchoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cmu.cc15619.rpc.proto.EchoRequest,
      cmu.cc15619.rpc.proto.EchoResponse> getEchoMethod() {
    io.grpc.MethodDescriptor<cmu.cc15619.rpc.proto.EchoRequest, cmu.cc15619.rpc.proto.EchoResponse> getEchoMethod;
      ...
      synchronized (EchoServiceGrpc.class) {
        if ((getEchoMethod = EchoServiceGrpc.getEchoMethod) == null) {
          EchoServiceGrpc.getEchoMethod = getEchoMethod =
              io.grpc.MethodDescriptor.<cmu.cc15619.rpc.proto.EchoRequest, cmu.cc15619.rpc.proto.EchoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Echo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cmu.cc15619.rpc.proto.EchoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cmu.cc15619.rpc.proto.EchoResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void echo(cmu.cc15619.rpc.proto.EchoRequest request,
        io.grpc.stub.StreamObserver<cmu.cc15619.rpc.proto.EchoResponse> responseObserver) {
  ...
  public static final class EchoServiceStub
    ...
    /**
     */
    public void echo(cmu.cc15619.rpc.proto.EchoRequest request,
        io.grpc.stub.StreamObserver<cmu.cc15619.rpc.proto.EchoResponse> responseObserver) {
  ...
  public static final class EchoServiceBlockingStub
    ...
    /**
     */
    public cmu.cc15619.rpc.proto.EchoResponse echo(cmu.cc15619.rpc.proto.EchoRequest request) {
  ...
  public static final class EchoServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<cmu.cc15619.rpc.proto.EchoResponse> echo(
        cmu.cc15619.rpc.proto.EchoRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ECHO:
          serviceImpl.echo((cmu.cc15619.rpc.proto.EchoRequest) request,
              (io.grpc.stub.StreamObserver<cmu.cc15619.rpc.proto.EchoResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              cmu.cc15619.rpc.proto.EchoRequest,
              cmu.cc15619.rpc.proto.EchoResponse>(
  ...
  private static abstract class EchoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cmu.cc15619.rpc.proto.EchoProto.getDescriptor();
    }
